...
#define file name
modelname   = 'Veg_Classifier_CNN_Tuning_Add_Layer_Conv_Choice_Xavier' 
...
def model(datagen, X_train, y_train, X_val, y_val):
    ...
    x = Flatten()(x)
    x = Dense({{choice([256, 512, 1024])}}, activation='relu',kernel_initializer=glorot_uniform(seed = 33))(x)
    x = Dense(128, activation='relu',kernel_initializer=glorot_uniform(seed = 33))(x)
    ...
    model.fit_generator(datagen.flow(X_train, y_train,
                        batch_size={{choice([64, 128])}}), epochs={{choice([100, 200])}},
