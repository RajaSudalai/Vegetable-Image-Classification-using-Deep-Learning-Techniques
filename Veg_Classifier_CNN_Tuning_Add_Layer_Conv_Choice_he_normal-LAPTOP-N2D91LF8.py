...
#define file name
modelname   = 'Veg_Classifier_CNN_Tunning_Add_Layer_Conv_Choice_he_normal' 
...
def model(datagen, X_train, y_train, X_val, y_val):
    ...
    x = Flatten()(x)
    x = Dense({{choice([256, 512, 1024])}}, activation='relu',kernel_initializer=he_normal(seed = 33))(x)
    x = Dense(128, activation='relu',kernel_initializer=he_normal(seed = 33))(x)
